...
TEST_CASES = [
    ...
    {"q": "公司注册地址在哪里？", "ref": "湖北省武汉市东湖新技术开发区（关山大道1号光谷软件园4.1期10栋综合单元6层09号）", "kw": ["武汉", "东湖"], "type": "事实型"},
    ...
    {"q": "公司面临的主要风险有哪些？", "ref": "技术风险（新技术研发试制）、经营风险（军队改革导致订单延迟、业绩波动）、募投项目风险、其他不可预见风险", "kw": ["风险"], "type": "分析型"},
    ...
    {"q": "军品收入占主营业务收入的比重是多少？", "ref": "82.10%、97.31%、94.84%、94.34%（报告期各期）", "kw": ["82.10"], "type": "对比型"},
    {"q": "发行前后股本结构有什么变化？", "ref": "发行前5520万股，发行后7360万股", "kw": ["5520", "7360", "1840"], "type": "对比型"},
    {"q": "公司与同行业公司相比研发投入如何？", "ref": "研发投入低于同行业平均水平，但调整口径后差距缩小", "kw": ["研发", "投入", "薪酬"], "type": "对比型"},
]
...
try:
    ...
    reranker = Reranker(model_path=os.getenv('RERANK_MODEL_PATH', ''), device='cpu')
    print('Reranker OK')
